...
The **audiocpp-diarize** skill wraps this endpoint end to end for diarization.
...
- Model volume: `/models-local` (`tts/`, `asr/`, `emb/`, `sd/`, `llama/`). The
  preflight reports whether the sandbox user can write there; if not, download into
